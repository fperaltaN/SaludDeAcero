...
<head runat="server">
   ...
   <%-- <link rel="icon" href="../../favicon.ico">--%>
    ...
    <link href="App_Data/css/jumbotron.css" rel="stylesheet" />

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <script src="App_Data/js/ie-emulation-modes-warning.js"></script>
...
<body>
    ...
    ================================================== -->
        ...
        <script src="App_Data/js/bootstrap.min.js"></script>
        <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
        <script src="App_Data/js/ie10-viewport-bug-workaround.js"></script>
</body>
</html>
