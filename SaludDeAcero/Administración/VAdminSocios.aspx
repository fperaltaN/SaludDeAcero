                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:Button class="btn btn-success" ID="btnGuardarEstado" runat="server" Text="Guardar Cambios" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" Text="Consultar Periodo" ID="btnConPago" class="btn btn-success"></asp:Button>
                        </div>
                        <div class="container">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <fieldset>
                                            ...
                                            <div style="text-align: right">
                                                <asp:Button runat="server" Text="Reimprimir Comprobante Seleccionado" ID="BtnReimprimir" class="btn-warning"></asp:Button>
